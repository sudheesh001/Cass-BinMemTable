    ...
    public static class Reduce extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
        ...
        public void configure(JobConf job) {
            ...
            */
            ...
            {
                String[] values = token.split(":"); // KV Pair split
                StorageService.instance().updateTokenMetadata(new BigIntegerToken(new BigInteger(values[0])),new EndPoint(values[1], 7000)); // Invoke storage service endpoints
            }
        }
        public void close()
        {
        ...
        public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException
        {
            ...
            String Keyspace = "TakingOverMySpace";
            String CFName = "HappilyTakingOverCassandra";
            Message message;
